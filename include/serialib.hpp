...
namespace sl
{
    ...
    private:
        ...
        mutable std::chrono::time_point<std::chrono::high_resolution_clock> read_previous_time { std::chrono::high_resolution_clock::now() };
        mutable std::chrono::time_point<std::chrono::high_resolution_clock> read_current_time  { std::chrono::high_resolution_clock::now() };
